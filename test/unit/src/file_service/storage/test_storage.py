...
class StorageUnitTestCase(TestCase):
    def test_get_download_url(self):
        ...
        mock_storage_imp.get_file_url = Mock(return_value="www.test.com/download/12345")

        storage = Storage(self.config, mock_storage_imp)

        result = storage.get_file_url(request)

        mock_storage_imp.get_file_url.assert_called_once_with(request)
    ...
    def test_upload_file(self):
        ...
        self.assertEqual(result.url, "www.test.com/download/12345")
